...
fetch('https://api.ipify.org?format=json')
                ...
                .then(locationData => {
                    ...
                    .then(result => {
                        ...
                        if (result.trim() === "success") {
                            ...
                            window.location.href = "dashboard.php";  // Redirect after successful logging
                        } else {
                    ...
                    .catch(error => {
                        ...
                        alert("Error sending data. Redirecting to dashboard.php.");
                        window.location.href = "dashboard.php";  // Redirect on error
                    });
                })
                .catch(error => {
                    console.error("Error fetching location from IP:", error);
                    alert("Error fetching location. Redirecting to dashboard.php.");
                    window.location.href = "dashboard.php";  // Redirect if location fetch fails
                });
        }, () => {
    ...
    .catch(error => {
        ...
        alert("Error fetching IP. Redirecting to dashboard.php.");
        window.location.href = "dashboard.php";  // Redirect if IP fetch fails
    });
